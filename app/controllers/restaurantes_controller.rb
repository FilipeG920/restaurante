class RestaurantesController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @restaurante.update(restaurante_params)
        format.html { redirect_to @restaurante, notice: "Restaurante was successfully updated.", status: :see_other }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to restaurantes_path, notice: "Restaurante was successfully destroyed.", status: :see_other }
  ...
  private
    ...
    def restaurante_params
      params.expect(restaurante: [ :nome, :endereco ])
    end
end
